...
public class TestCasAtomicInteger {
  ...
  private static void timeSequentialGetAndAdd() {
    ...
    System.out.println(Mark7("MyAtomicInteger", new IntToDouble() {
    ...
    System.out.println(Mark7("AtomicInteger", new IntToDouble() {
        public double call(int i) { 
...
class MyAtomicInteger {
  ...
  // Model implementation of compareAndSet to illustrate it meaning.
  // In reality, compareAndSet is not implemented using locks, but the
